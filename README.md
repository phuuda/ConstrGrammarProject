...
В русском языке оценочная конструкция <i>X, а не Y</i>	чаще встречается с положительной тональностью, чем <i>не Y, а X</i>.<br />
Выбор X влияет на порядок слов в конструкции: определенная частотная оценка тяготеет к определенному порядку слов.<br />
